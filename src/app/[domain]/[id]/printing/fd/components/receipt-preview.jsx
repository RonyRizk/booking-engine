...
import { DocumentHeader } from '../../cl/components/document-header';
 ...
 */
export function ReceiptPreview({ booking, property, documentNumber, pid, setupTables }) {
