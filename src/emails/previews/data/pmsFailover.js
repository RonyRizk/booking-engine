...
export const pmsFailOverData = {
    reason: `{ "status_code": "400-24", "error": { "ErrorCode": "400-24", "ErrorDescription": "400-24 : (BAD_REQUEST).(INVALID) Rates are not available for selected stay dates/room type/rate type/currency." }, "bookings": [] }`,
