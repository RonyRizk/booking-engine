export default function RoomDateRange({ room, printingService, mode }) {
    return (
        <div className="flex items-center gap-4">
            ...
            {mode === "printing" && room.departure_time?.description && (
                <p>(Expected departure: {room.departure_time.description})</p>
            )}
        </div>
    );
}
